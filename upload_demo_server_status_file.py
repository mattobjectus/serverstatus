...
SOURCE_FILE_PATH='test/demo/serviceChk_finprodcoredc.txt'
lastFileTimestamp = ""
# Infinite loop to continuously upload the file
while True:

    fileTimestamp = os.path.getmtime(SOURCE_FILE_PATH)
    if (lastFileTimestamp != fileTimestamp):
        print(f"Uploading file: {SOURCE_FILE_PATH}")
